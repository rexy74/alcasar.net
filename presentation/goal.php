...
<div id="goal" >
     ...
     <div class="flex-section">
        <div class="col-1">
            <div class="text">
                    ...
                    <h3><?= $file_content['num_2'] ?></h3>
                    <p>     <?= $file_content['num_3'] ?></p>
    ...
    <div class="flex-section reverse">
        <div class="col-1">
            <div class="text">
                        <h3><?= $file_content['num_5'] ?></h3>
                        <p><?= $file_content['num_6'] ?></p>
                        <p><?= $file_content['num_7'] ?></p>
                    <div class="row ">
        ...
        <div class="col-1">
            <div class="text">
                    ...
                    <div class="col-md-6 textSize">
                     ...
                     <h4><?= $file_content['num_19'] ?></h4>
                    <p><?= $file_content['num_20'] ?></p>
                      <div class="row ">
                    <div class="col-md-6 textSize">
                         <?= $file_content['num_21'] ?>
                    </div>
