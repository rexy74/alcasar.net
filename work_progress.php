        ...
        <div class="container">        
                ...
                <div class="centerbar">
                    <div class="progress progress-striped active styleBar"  >
                      <div class="progress-bar progress-bar-info contentBar" role="progressbar" aria-valuenow="20" aria-valuemin="0"  aria-valuemax="100"  style="width: 95%">
                        <?php echo "$file_cont[doc_task]"; ?>
                      </div>
                    </div>
                </div>  
                    <p class="positionAuthor"><?php echo "$file_cont[author_doc]"; ?> </p>
            </div>


               <div id="coreTitle">
                  <h2 class="fixPstCore"> <i class="fa fa-gears"></i> <?php echo "$file_cont[core_title]"; ?>  </h2>
              
              <?php  
                    $pair = "false";
                    if(($file_cont[nbCore_task]%2) == O)
                    {
            ...
            <div id="graphicalAcc" class="">
              ...
              <div class="text-center" > 
                <h2 class="graph fixPstGraph"><?php echo "$file_cont[design_title]"; ?>  </h2>
